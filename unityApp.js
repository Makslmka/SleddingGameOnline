const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/SleddingGame[1]-mirraSDK[5.1.11].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/SleddingGame[1]-mirraSDK[5.1.11].data.unityweb",
            frameworkUrl: buildUrl + "/SleddingGame[1]-mirraSDK[5.1.11].framework.js.unityweb",
            codeUrl: buildUrl + "/SleddingGame[1]-mirraSDK[5.1.11].wasm.unityweb",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "DefaultCompany",
            productName: "SleddingGame",
            productVersion: "0.1",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
